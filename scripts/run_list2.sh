...
RUNLIST="5254 5255 5256 5260 5261 5265 5266 5273 5274 5275 5276 5277 5278 5281 5282 5284 5304 5306 5313 5159 5215 5217 5218 5219 5220"
...
#RUNLIST="`ls -1 DATA/hd_rawdata_${RUNNUM}_???.evio `"
...
for run in $RUNLIST ; do
    ...
    RUN0="DATA/hd_rawdata_${RUNNUM}_000.evio"
    ls -l $RUN0 > /dev/null
    RETC=$?
    echo "rc=$RETC"
    if [[ $RETC != "0" ]] ; then
